...
const CartItem = ({ item, products, setCart }) => {
  ...
  return (
    <div className="cart-item-wrap grid grid-cols-3 gap-6 mb-9  border-t  border-gray-200 p-5">
      ...
      <div className="col-span-2 cart-right-col">
        <div className="flex justify-between flex-col h-full">
          <div className="cart-product-title-wrap relative">
            <h3 className="cart-product-title text-brand-orange font-medium text-gray-700 hover:text-gray-800">
              {item?.data?.name}
            </h3>
          ...
          <footer className="cart-product-footer flex justify-between p-4 border-t border-brand-bright-grey">
            <div className="">
              <span className="cart-total-price mt-1 text-sm font-medium text-gray-900">
                {item?.currency}
                {item?.line_subtotal}
              </span>
            </div>
